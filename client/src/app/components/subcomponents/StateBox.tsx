...
function StateBox({ state }: StateBoxComponentProps) {
  if (state === "Open") {
    return (
      <div className="min-w-[52px] w-auto p-2 bg-[#238636] flex flex-row items-center gap-x-2 rounded-lg cursor-pointer">
  ...
  if (state === "Closed") {
    return (
      <div className="min-w-[52px] w-auto p-2 bg-[#8957E5] flex flex-row items-center gap-x-2 rounded-lg cursor-pointer">
  ...
  if (state === "Saved") {
    return (
      <div className="min-w-[52px] w-auto p-2 bg-[#6f6f6f] flex flex-row items-center gap-x-2 rounded-lg cursor-pointer">
