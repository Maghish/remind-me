...
function Navbar(props) {
    return (
        <div className="bg-[#252525] w-full min-h-[72px] flex items-center pl-9 pr-4">
            ...
            <p className="font-mono ml-auto text-stone-400 pl-10 text-md hover:text-white">Loggin In as {props.username}</p>
        </div>
    )
}
